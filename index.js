module.exports = {
  ra: {
    ...
    message: {
      ...
      bulk_delete_content: 'Ste si istí, že chcete zmazať %{name}? |||| Ste si istí, že chcete zmazať tieto %{smart_count} položky?',
      bulk_delete_title: 'Zmazať %{name} |||| Zmazať %{smart_count} %{name}',
    ...
    navigation: {
      ...
      page_rows_per_page: 'Zýzanmy na strane:',
      next: 'Ďalšia',
      prev: 'Predošlá',
    },
    auth: {
